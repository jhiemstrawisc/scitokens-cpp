...
protected:
  ...
  // Reference copy of the keys at https://demo.scitokens.org/oauth2/certs; may
  // need to be updated periodically.
  std::string demo_scitokens =
      "{\"keys\":[{\"alg\":\"RS256\",\"e\":\"AQAB\",\"kid\":\"key-rs256\","
      "\"kty\":\"RSA\",\"n\":\"uGDGTLXnqh3mfopjys6sFUBvFl3F4Qt6NEYphq_u_"
      "aBhtN1X9NEyb78uB_I1KjciJNGLIQU0ECsJiFx6qV1hR9xE1dPyrS3bU92AVtnBrvzUtTU-"
      "aUZAmZQiuAC_rC0-z_"
      "TOQr6qJkkUgZtxR9n9op55ZBpRfZD5dzhkW4Dm146vfTKt0D4cIMoMNJS5xQx9nibeB4E8hr"
      "yZDW_"
      "fPeD0XZDcpByNyP0jFDYkxdUtQFvyRpz4WMZ4ejUfvW3gf4LRAfGZJtMnsZ7ZW4RfoQbhiXK"
      "MfWeBEjQDiXh0r-KuZLykxhYJtpf7fTnPna753IzMgRMmW3F69iQn2LQN3LoSMw==\","
...
protected:
  void SetUp() override {
    ...
    rv = scitoken_store_public_ec_key("https://demo.scitokens.org/gtest", "1",
                                      ec_public, &err_msg);
    ASSERT_TRUE(rv == 0);
...
TEST_F(SerializeTest, TestStringList) {
  ...
  char **value;
  auto rv =
      scitoken_get_claim_string_list(m_token.get(), "groups", &value, &err_msg);
  ASSERT_TRUE(rv == 0);
  ASSERT_TRUE(value != nullptr);
...
TEST_F(SerializeTest, EnforcerTest) {
  ...
  rv =
      scitoken_set_claim_string(m_token.get(), "scope", "read:/blah", &err_msg);
  ASSERT_TRUE(rv == 0);

  rv =
      scitoken_set_claim_string(m_token.get(), "ver", "scitoken:2.0", &err_msg);
  ASSERT_TRUE(rv == 0);
...
TEST_F(SerializeTest, ExplicitTime) {
  ...
  scitoken_set_serialize_profile(m_token.get(), SciTokenProfile::WLCG_1_0);
  auto rv = scitoken_set_claim_string(m_token.get(), "scope", "storage.read:/",
                                      &err_msg);
