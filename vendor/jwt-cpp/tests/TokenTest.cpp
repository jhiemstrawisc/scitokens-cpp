...
TEST(TokenTest, CreateToken) {
    auto token = jwt::create().set_issuer("auth0").set_type("JWS").sign(
        jwt::algorithm::none{});
    ASSERT_EQ("eyJhbGciOiJub25lIiwidHlwIjoiSldTIn0.eyJpc3MiOiJhdXRoMCJ9.",
              token);
}
...
TEST(TokenTest, CreateTokenRS512) {
    ...
    ASSERT_EQ("eyJhbGciOiJSUzUxMiIsInR5cCI6IkpXUyJ9.eyJpc3MiOiJhdXRoMCJ9."
              ...
              "Xv9pHdA1umidQZG3a7gWvHsujqybCBgBraMTd1wJrCl4QxFg2RYHhHbRqb9BnPJg"
              "FD_vryd4GB"
...
TEST(TokenTest, CreateTokenEd448) {
    ...
    ASSERT_THROW(jwt::verify()
                     .allow_algorithm(jwt::algorithm::ed448(
                         ed448_pub_key_invalid, "", "", ""))
                     .verify(decoded),
                 jwt::signature_verification_exception);
    ASSERT_NO_THROW(
        jwt::verify()
...
TEST(TokenTest, VerifyTokenRS512) {
    std::string token =
        ...
        "Xv9pHdA1umidQZG3a7gWvHsujqybCBgBraMTd1wJrCl4QxFg2RYHhHbRqb9BnPJgFD_"
        "vryd4"
...
TEST(TokenTest, VerifyTokenES521) {
    const std::string token =
        ...
        "BFgwKidECWCNc4VINEqFEFdApC2y3YRdkpKX2etAWI7yYudAlxJ7Z17m6GwAoLOGaeNons"
        "aKOe1UnC5W86eoXrCoPRgzsFTpKIb8NiolcYWjIY"
        "-r8gQd7BZ7whaj9Ft";
