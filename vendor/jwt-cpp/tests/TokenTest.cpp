...
TEST(TokenTest, CreateTokenHS256) {
  ...
  ASSERT_EQ("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXUyJ9.eyJpc3MiOiJhdXRoMCJ9."
            "AbIJTDMFc7yUa5MhvcP03nJPyCPzZtQcGEp-zWfOkEE",
            token);
}
...
TEST(TokenTest, CreateTokenRS256) {
  ...
  ASSERT_EQ("eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXUyJ9.eyJpc3MiOiJhdXRoMCJ9."
            ...
            "YD0iZhNIcI7a654u5yPYyTlf5kjR97prCf_OXWRn-bYY74zna4p_"
            "bP9oWCL4BkaoRcMxi-IR7kmVcCnvbYqyIrKloXP2qPO442RBGqU7Ov9"
...
TEST(TokenTest, CreateTokenRS512) {
  ...
  ASSERT_EQ("eyJhbGciOiJSUzUxMiIsInR5cCI6IkpXUyJ9.eyJpc3MiOiJhdXRoMCJ9."
            "GZhnjtsvBl2_KDSxg4JW6xnmNjr2mWhYSZSSQyLKvI0"
            "TK86sJKchkt_HDy2IC5l5BGRhq_"
            "Xv9pHdA1umidQZG3a7gWvHsujqybCBgBraMTd1wJrCl4QxFg2RYHhHbRqb9BnPJgFD"
            "_vryd4GB"
...
TEST(TokenTest, CreateTokenES256) {
  ...
  ASSERT_THROW(jwt::verify()
                   .allow_algorithm(jwt::algorithm::es256(
                       ecdsa256_pub_key_invalid, "", "", ""))
                   .verify(decoded),
               jwt::signature_verification_exception);
  ASSERT_NO_THROW(
      jwt::verify()
          .allow_algorithm(jwt::algorithm::es256(ecdsa256_pub_key, "", "", ""))
          .verify(decoded));
}
...
TEST(TokenTest, CreateTokenES384) {
  ...
  ASSERT_THROW(jwt::verify()
                   .allow_algorithm(jwt::algorithm::es384(
                       ecdsa384_pub_key_invalid, "", "", ""))
                   .verify(decoded),
               jwt::signature_verification_exception);
  ASSERT_NO_THROW(
      jwt::verify()
          .allow_algorithm(jwt::algorithm::es384(ecdsa384_pub_key, "", "", ""))
          .verify(decoded));
}
...
TEST(TokenTest, CreateTokenES512) {
  ...
  ASSERT_THROW(jwt::verify()
                   .allow_algorithm(jwt::algorithm::es512(
                       ecdsa521_pub_key_invalid, "", "", ""))
                   .verify(decoded),
               jwt::signature_verification_exception);
  ASSERT_NO_THROW(
      jwt::verify()
          .allow_algorithm(jwt::algorithm::es512(ecdsa521_pub_key, "", "", ""))
          .verify(decoded));
}
...
TEST(TokenTest, CreateTokenEd25519) {
  ...
  ASSERT_THROW(jwt::verify()
                   .allow_algorithm(jwt::algorithm::ed25519(
                       ed25519_pub_key_invalid, "", "", ""))
                   .verify(decoded),
               jwt::signature_verification_exception);
  ASSERT_NO_THROW(
      jwt::verify()
          .allow_algorithm(jwt::algorithm::ed25519(ed25519_pub_key, "", "", ""))
          .verify(decoded));
}
...
TEST(TokenTest, CreateTokenEd448) {
  ...
  ASSERT_THROW(jwt::verify()
                   .allow_algorithm(
                       jwt::algorithm::ed448(ed448_pub_key_invalid, "", "", ""))
                   .verify(decoded),
               jwt::signature_verification_exception);
  ASSERT_NO_THROW(
      jwt::verify()
          .allow_algorithm(jwt::algorithm::ed448(ed448_pub_key, "", "", ""))
          .verify(decoded));
}
#endif
...
TEST(TokenTest, VerifyTokenNoneFail) {
  ...
  std::string token = "eyJhbGciOiJub25lIiwidHlwIjoiSldUIn0."
                      "eyJpYXQiOjE1OTUyNjc1MTZ9.cmFuZG9tc2ln";

  auto verify = jwt::verify().allow_algorithm(jwt::algorithm::none{});

  auto decoded_token = jwt::decode(token);

  ASSERT_THROW(verify.verify(decoded_token),
               jwt::signature_verification_exception);
}
...
TEST(TokenTest, VerifyTokenRS256Fail) {
  ...
  auto verify = jwt::verify()
                    .allow_algorithm(
                        jwt::algorithm::rs256(rsa_pub_key_invalid, "", "", ""))
                    .with_issuer("auth0");
...
TEST(TokenTest, VerifyTokenRS512) {
  std::string token =
      "eyJhbGciOiJSUzUxMiIsInR5cCI6IkpXUyJ9.eyJpc3MiOiJhdXRoMCJ9.GZhnjtsvBl2_"
      "KDSxg4JW6xnmNjr2mWhYSZ"
      "SSQyLKvI0TK86sJKchkt_HDy2IC5l5BGRhq_"
      "Xv9pHdA1umidQZG3a7gWvHsujqybCBgBraMTd1wJrCl4QxFg2RYHhHbRqb9BnPJgFD_vryd4"
      "GBhfGgejPBCBlGrQtqFGFdHHOjNHY";

  auto verify = jwt::verify()
                    .allow_algorithm(jwt::algorithm::rs512(
                        rsa512_pub_key, rsa512_priv_key, "", ""))
                    .with_issuer("auth0");
...
TEST(TokenTest, VerifyTokenRS512Fail) {
  ...
  auto verify = jwt::verify()
                    .allow_algorithm(
                        jwt::algorithm::rs512(rsa_pub_key_invalid, "", "", ""))
                    .with_issuer("auth0");
...
TEST(TokenTest, VerifyTokenHS256FailSignatureLength) {
  std::string token =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXUyJ9.eyJpc3MiOiJhdXRoMCJ9."
      "AbIJTDMFc7yUa5MhvcP03nJPyCPzZtQcGEp-zWfOkA";
...
TEST(TokenTest, VerifyFail) {
  {
...

    {
      auto verify = jwt::verify()
                        ...
                        .with_issuer("auth");
      ASSERT_THROW(verify.verify(decoded_token),
                   jwt::token_verification_exception);
    }
    {
      auto verify = jwt::verify()
                        .allow_algorithm(jwt::algorithm::none{})
...
TEST(TokenTest, VerifyTokenES256) {
  const std::string token =
      "eyJhbGciOiJFUzI1NiJ9.eyJpc3MiOiJhdXRoMCJ9.4iVk3-Y0v4RT4_9IaQlp-8dZ_"
...
TEST(TokenTest, VerifyTokenES256Fail) {
  ...
  auto verify = jwt::verify().allow_algorithm(
      jwt::algorithm::es256(ecdsa256_pub_key_invalid, "", "", ""));
  auto decoded_token = jwt::decode(token);
...
TEST(TokenTest, VerifyTokenES384) {
  const std::string token =
      "eyJhbGciOiJFUzM4NCIsInR5cCI6IkpXUyJ9.eyJpc3MiOiJhdXRoMCJ9.nTUwWanmj_"
      "K1VZM5it1ES-1FbnmRDL-lH3V_Fem-"
      "AhMur9Q61yZfKIydrpdavkm_SMxEsUGPVoqkpoEsjFjrtzMDs5s9yaFYD_"
      "ydiy1dsn9VbcI55voA3XwEcWFiPHri";
...
TEST(TokenTest, VerifyTokenES384Fail) {
  ...
  auto verify = jwt::verify().allow_algorithm(
      jwt::algorithm::es384(ecdsa384_pub_key_invalid, "", "", ""));
  auto decoded_token = jwt::decode(token);
...
TEST(TokenTest, VerifyTokenES521) {
  const std::string token =
      "eyJhbGciOiJFUzUxMiIsInR5cCI6IkpXUyJ9.eyJpc3MiOiJhdXRoMCJ9.ASF5hh9_"
      "Jyujzm3GRBttoth-3I6lCcwqun9Tt7Ekz9_23BN6-"
      "BFgwKidECWCNc4VINEqFEFdApC2y3YRdkpKX2etAWI7yYudAlxJ7Z17m6GwAoLOGaeNonsaK"
      "Oe1UnC5W86eoXrCoPRgzsFTpKIb8NiolcYWjIY"
      "-r8gQd7BZ7whaj9Ft";
...
TEST(TokenTest, VerifyTokenES521Fail) {
  ...
  auto verify = jwt::verify().allow_algorithm(
      jwt::algorithm::es512(ecdsa521_pub_key_invalid, "", "", ""));
  auto decoded_token = jwt::decode(token);
...
TEST(TokenTest, VerifyTokenPS256Fail) {
  ...
  auto verify = jwt::verify()
                    .allow_algorithm(
                        jwt::algorithm::ps256(rsa_pub_key_invalid, "", "", ""))
                    .with_issuer("auth0");
...
TEST(TokenTest, VerifyTokenEd25519) {
  const std::string token =
      "eyJhbGciOiJFZERTQSIsInR5cCI6IkpXUyJ9.eyJpc3MiOiJhdXRoMCJ9."
      "OujgVcO8xQx5xLcAYWENCRU1SCGH5HcX4MX4o6wU3M4"
      "DOnKiNmc0O2AnvQlzr-9cgI4QGQzeC6gz_fgLoesADg";

  auto verify = jwt::verify().allow_algorithm(
      jwt::algorithm::ed25519(ed25519_pub_key, "", "", ""));
  auto decoded_token = jwt::decode(token);
...
TEST(TokenTest, VerifyTokenEd25519Fail) {
  ...
  auto verify = jwt::verify().allow_algorithm(
      jwt::algorithm::ed25519(ed25519_pub_key_invalid, "", "", ""));
  auto decoded_token = jwt::decode(token);
...
TEST(TokenTest, VerifyTokenEd448) {
  const std::string token =
      "eyJhbGciOiJFZERTQSIsInR5cCI6IkpXUyJ9.eyJpc3MiOiJhdXRoMCJ9."
      "Aldes9jrXZXxfNjuovqmIZ3r2WF4yVXVr2Q8B8SkAmv"
      "Bsw_3MHs8HtgKeXbqKFYWpHOCtmZJcH-AWMvoY6FCNdQqbESGTkv58O6tFbXDD_"
      "nLejWNAOuvcO2LPMySmkVNQUopmQf_HO62Mug1ngepUDE"
      "A";

  auto verify = jwt::verify().allow_algorithm(
      jwt::algorithm::ed448(ed448_pub_key, "", "", ""));
  auto decoded_token = jwt::decode(token);
...
TEST(TokenTest, VerifyTokenExpireFail) {
  ...
  auto verify = jwt::verify<test_clock, jwt::traits::kazuho_picojson>(
                    {std::chrono::system_clock::from_time_t(110)})
                    .allow_algorithm(jwt::algorithm::none{});
  ASSERT_THROW(verify.verify(decoded_token), jwt::token_verification_exception);
  std::error_code ec;
  ...
  ASSERT_EQ(
      ec.value(),
      static_cast<int>(jwt::error::token_verification_error::token_expired));
}
...
TEST(TokenTest, VerifyTokenExpire) {
  ...
  auto verify = jwt::verify<test_clock, jwt::traits::kazuho_picojson>(
                    {std::chrono::system_clock::from_time_t(90)})
                    .allow_algorithm(jwt::algorithm::none{});
...
TEST(TokenTest, VerifyTokenType) {
  ...
  auto verify =
      jwt::verify().with_type("jws").allow_algorithm(jwt::algorithm::none{});
  ASSERT_NO_THROW(verify.verify(decoded_token));
  std::error_code ec;
  ASSERT_NO_THROW(verify.verify(decoded_token, ec));
  ASSERT_FALSE(!(!ec));
...
TEST(TokenTest, GetClaimThrows) {
  ...
  ASSERT_THROW(decoded_token.get_header_claim("test"),
               jwt::error::claim_not_present_exception);
  ASSERT_THROW(decoded_token.get_payload_claim("test"),
               jwt::error::claim_not_present_exception);
}

TEST(TokenTest, ThrowInvalidKeyLength) {
  // We should throw if passed the wrong size
  ASSERT_THROW(jwt::algorithm::es256(ecdsa384_pub_key, ""),
               jwt::ecdsa_exception);
  ASSERT_THROW(jwt::algorithm::es256("", ecdsa384_priv_key),
               jwt::ecdsa_exception);
  ASSERT_THROW(jwt::algorithm::es256(ecdsa384_pub_key, ecdsa384_priv_key),
               jwt::ecdsa_exception);
  ASSERT_THROW(jwt::algorithm::es256(ecdsa521_pub_key, ""),
               jwt::ecdsa_exception);
  ASSERT_THROW(jwt::algorithm::es256("", ecdsa521_priv_key),
               jwt::ecdsa_exception);
  ASSERT_THROW(jwt::algorithm::es256(ecdsa521_pub_key, ecdsa521_priv_key),
               jwt::ecdsa_exception);

  // But also if only one cert has the wrong size
  ASSERT_THROW(jwt::algorithm::es256(ecdsa256_pub_key, ecdsa384_priv_key),
               jwt::ecdsa_exception);
  ASSERT_THROW(jwt::algorithm::es256(ecdsa256_pub_key, ecdsa521_priv_key),
               jwt::ecdsa_exception);

  ASSERT_THROW(jwt::algorithm::es384(ecdsa256_pub_key, ""),
               jwt::ecdsa_exception);
  ASSERT_THROW(jwt::algorithm::es384("", ecdsa256_priv_key),
               jwt::ecdsa_exception);
  ASSERT_THROW(jwt::algorithm::es384(ecdsa256_pub_key, ecdsa256_priv_key),
               jwt::ecdsa_exception);
  ASSERT_THROW(jwt::algorithm::es384(ecdsa521_pub_key, ""),
               jwt::ecdsa_exception);
  ASSERT_THROW(jwt::algorithm::es384("", ecdsa521_priv_key),
               jwt::ecdsa_exception);
  ASSERT_THROW(jwt::algorithm::es384(ecdsa521_pub_key, ecdsa521_priv_key),
               jwt::ecdsa_exception);

  ASSERT_THROW(jwt::algorithm::es384(ecdsa384_pub_key, ecdsa256_priv_key),
               jwt::ecdsa_exception);
  ASSERT_THROW(jwt::algorithm::es384(ecdsa384_pub_key, ecdsa521_priv_key),
               jwt::ecdsa_exception);

  ASSERT_THROW(jwt::algorithm::es512(ecdsa256_pub_key, ""),
               jwt::ecdsa_exception);
  ASSERT_THROW(jwt::algorithm::es512("", ecdsa256_priv_key),
               jwt::ecdsa_exception);
  ASSERT_THROW(jwt::algorithm::es512(ecdsa256_pub_key, ecdsa256_priv_key),
               jwt::ecdsa_exception);
  ASSERT_THROW(jwt::algorithm::es512(ecdsa384_pub_key, ""),
               jwt::ecdsa_exception);
  ASSERT_THROW(jwt::algorithm::es512("", ecdsa384_priv_key),
               jwt::ecdsa_exception);
  ASSERT_THROW(jwt::algorithm::es512(ecdsa384_pub_key, ecdsa384_priv_key),
               jwt::ecdsa_exception);

  ASSERT_THROW(jwt::algorithm::es512(ecdsa521_pub_key, ecdsa256_priv_key),
               jwt::ecdsa_exception);
  ASSERT_THROW(jwt::algorithm::es512(ecdsa521_pub_key, ecdsa384_priv_key),
               jwt::ecdsa_exception);
