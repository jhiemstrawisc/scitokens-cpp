...
TEST(BaseTest, Base64DecodeURL) {
    ...
    ASSERT_EQ("1234",
              jwt::base::decode<jwt::alphabet::base64url>("MTIzNA%3d%3d"));
}
...
TEST(BaseTest, Base64EncodeURL) {
    ...
    ASSERT_EQ("MTIzNA%3d%3d",
              jwt::base::encode<jwt::alphabet::base64url>("1234"));
}
...
TEST(BaseTest, Base64PadURL) {
    ...
    ASSERT_EQ("MTIzNA%3d%3d",
              jwt::base::pad<jwt::alphabet::base64url>("MTIzNA"));
}
...
TEST(BaseTest, Base64TrimURL) {
    ...
    ASSERT_EQ("MTIzNA",
              jwt::base::trim<jwt::alphabet::base64url>("MTIzNA%3d%3d"));
}
