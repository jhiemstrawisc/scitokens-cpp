...
EVP_PKEY *PEM_read_bio_PUBKEY(BIO *bp, EVP_PKEY **x, pem_password_cb *cb,
                              void *u) {
  static EVP_PKEY *(*origMethod)(BIO * bp, EVP_PKEY * *x, pem_password_cb * cb,
                                 void *u) = nullptr;
  if (origMethod == nullptr)
...
int EVP_DigestSignFinal(EVP_MD_CTX *ctx, unsigned char *sigret,
  ...
  if (origMethod == nullptr)
    origMethod = (decltype(origMethod))dlsym(RTLD_NEXT, "EVP_DigestSignFinal");
...
int EVP_SignFinal(EVP_MD_CTX *ctx, unsigned char *md, unsigned int *s,
                  EVP_PKEY *pkey) {
  static int (*origMethod)(EVP_MD_CTX * ctx, unsigned char *md, unsigned int *s,
...
EVP_PKEY_CTX *EVP_PKEY_CTX_new_from_pkey(OSSL_LIB_CTX *libctx, EVP_PKEY *pkey,
  ...
  if (origMethod == nullptr)
    origMethod =
        (decltype(origMethod))dlsym(RTLD_NEXT, "EVP_PKEY_CTX_new_from_pkey");
...
EC_KEY *EVP_PKEY_get1_EC_KEY(EVP_PKEY *pkey) {
  ...
  if (origMethod == nullptr)
    origMethod = (decltype(origMethod))dlsym(RTLD_NEXT, "EVP_PKEY_get1_EC_KEY");
...
ECDSA_SIG *d2i_ECDSA_SIG(ECDSA_SIG **psig, const unsigned char **ppin,
                         long len) {
  static ECDSA_SIG *(*origMethod)(ECDSA_SIG * *psig, const unsigned char **ppin,
                                  long len) = nullptr;
  if (origMethod == nullptr)
...
TEST(OpenSSLErrorTest, HMACSign) {
  ...
  run_multitest(mapping,
                [&](std::error_code &ec) { verify.verify(decoded_token, ec); });
}
...
TEST(OpenSSLErrorTest, RS256VerifyErrorCode) {
  ...
  auto signature = jwt::base::decode<jwt::alphabet::base64>(
      "oCJUeLmIKKVVE/UWhEL/"
      "Malx0l9TCoXWNAS2z9o8ZYNaS4POIeadZWeUbLdICx3SCJCnGRwL8JkAmYx1wexT2QGuVXXA"
      "tZvRu8ceyuQy"
...
TEST(OpenSSLErrorTest, PS256VerifyErrorCode) {
  ...
  std::string signature =
      ...
      "GRrYJqZvCdbcadi6amNKCfeIl6a5mp2VCM55NsPoRxsmSzc1G7AHWb1ckOCsm3KY5BL6B074"
      "bHgoqO3yaLlKWLAcy4OYyRpJ/wnZQ9PPrhwdq/"
      "B59uW3x1QUCKYKgZeqZOoqIP1YgLwvEpPtXYutQCFr4eBKgV7vdtE0wgHR43ka16fi5L4Sya"
      "Zv53NCg==";
