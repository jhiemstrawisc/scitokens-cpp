...
TEST(OpenSSLErrorTest, RS256Reference) {
    ...
    ASSERT_EQ(jwt::base::encode<jwt::alphabet::base64>(res),
              "oCJUeLmIKKVVE/UWhEL/"
              "Malx0l9TCoXWNAS2z9o8ZYNaS4POIeadZWeUbLdICx3SCJCnGRwL8JkAmYx1wexT"
              "2QGuVXXAtZvRu8ceyuQy"
              "AhzGkI9HdADu5YAJsUaLknDUV5hmundXQY8lhwQnKFXW0rl0H8DoFiPQErFmcKI6"
              "PA9NVGK/LSiqHqesNeg0wqCTxMmeT6pqI7FH9fDO"
...
TEST(OpenSSLErrorTest, RS256VerifyErrorCode) {
    ...
    auto signature = jwt::base::decode<jwt::alphabet::base64>(
        ...
        "K/LSiqHqesNeg0wqCTxMmeT6pqI7FH9fDO"
...
TEST(OpenSSLErrorTest, PS256VerifyErrorCode) {
    ...
    std::string signature =
        ...
        "74bHgoqO3yaLlKWLAcy4OYyRpJ/wnZQ9PPrhwdq/"
