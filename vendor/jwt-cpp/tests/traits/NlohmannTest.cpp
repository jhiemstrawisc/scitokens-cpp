...
TEST(NlohmannTest, BasicClaims) {
    ...
    const auto integer =
        jwt::basic_claim<jwt::traits::nlohmann_json>(159816816);
...
TEST(NlohmannTest, SetArray) {
    ...
    auto token = jwt::create<jwt::traits::nlohmann_json>()
                     .set_payload_claim(
                         "test", jwt::basic_claim<jwt::traits::nlohmann_json>(
                                     vect.begin(), vect.end()))
...
TEST(NlohmannTest, VerifyArray) {
    ...
    std::vector<int64_t> vect = {100, 20, 10};
    jwt::basic_claim<jwt::traits::nlohmann_json> array_claim(vect.begin(),
                                                             vect.end());
    const auto verify = jwt::verify<jwt::traits::nlohmann_json>()
